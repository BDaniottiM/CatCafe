...
btnPedido.click(() => {
  ...
  for (let index = 0; index < linhaTabela.length; index++) {
    ...
    let itemQuantidade = element.querySelector(
      "#dados-venda-quantidade"
    ).textContent;
  ...
  if (nomePedido.val().length > 0 && enderecoPedido.val().length > 0) {
    $.ajax({
      type: "POST",
      url: "https://discord.com/api/webhooks/1228594984073171034/VZcEHcn74k0g8lDOHjmM-qp9oXLlyhwl8JVU02agceANjuIo6ohtXsT6eXh-TkGbI4l8",
      data: JSON.stringify(
        gerarEmbed(
          nomePedido.val(),
          telefonePedido.val(),
...
function gerarEmbed(
  ...
  let jsonBase = {
    username: "Delivery",
    avatar_url:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjFzg7tNBHa8UkeQCQsZ6MWYnzlaeLdir29-YcF_mWNd-IUKmzkMsZ5d4wPtwdj4pVUY8&usqp=CAU",
    ...
    embeds: [
      ...
      },
      {
        ...
        thumbnail: {},
        footer: {},
        fields: [{ name: "Observações", value: "N/A" }],
      },
      {
        color: 5763719,
        timestamp: "",
